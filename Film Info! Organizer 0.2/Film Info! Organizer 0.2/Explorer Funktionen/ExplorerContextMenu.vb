...
#Region "InvokeCommand"
        Private Sub InvokeCommand(ByVal oContextMenu As IContextMenu, ByVal nCmd As UInteger, ByVal strFolder As String, ByVal pointInvoke As Point)
...
#Region "GetDesktopFolder()"
        ...
        Private Function GetDesktopFolder() As IShellFolder
            ...
            If _oDesktopFolder Is Nothing Then
...
#Region "GetParentFolder()"
        ...
        Private Function GetParentFolder(ByVal folderName As String) As IShellFolder
            If _oParentFolder Is Nothing Then
                Dim oDesktopFolder As IShellFolder = GetDesktopFolder()
                If oDesktopFolder Is Nothing Then
                    Return Nothing
                End If
                ...
                Dim pUnknownParentFolder As IntPtr = IntPtr.Zero
...
#Region "GetPIDLs()"
        ...
        Protected Function GetPIDLs(ByVal arrFI As FileInfo()) As IntPtr()
            If arrFI Is Nothing OrElse 0 = arrFI.Length Then
                Return Nothing
            End If
            ...
            Dim arrPIDLs As IntPtr() = New IntPtr(arrFI.Length - 1) {}
            Dim n As Integer = 0
...
#Region "FreePIDLs()"
        ...
        Protected Sub FreePIDLs(ByVal arrPIDLs As IntPtr())
            If arrPIDLs IsNot Nothing Then
...
#Region "InvokeContextMenuDefault"
        Private Sub InvokeContextMenuDefault(ByVal arrFI As FileInfo())
            ...
            Try
                ...
                Dim nResult As Integer = _oContextMenu.QueryContextMenu(pMenu, 0, CMD_FIRST, CMD_LAST, CMF.DEFAULTONLY Or CMF.EXTENDEDVERBS)

                Dim nDefaultCmd As UInteger = CUInt(GetMenuDefaultItem(pMenu, False, 0))
...
#Region "ShowContextMenu()"
        ...
        Public Sub ShowContextMenu(ByVal files As FileInfo(), ByVal pointScreen As POINT)
            ' Release all resources first.
            ReleaseAll()
        ...
        ''' <param name="pointScreen">Where to show the menu</param>
        Public Sub ShowContextMenu(ByVal dirs As DirectoryInfo(), ByVal pointScreen As Point)
            ' Release all resources first.
            ReleaseAll()
        ...
        ''' <param name="pointScreen">Where to show the menu</param>
        Private Sub ShowContextMenu(ByVal pointScreen As Point)
            ...
            Try
                ...
                Dim nResult As Integer = _oContextMenu.QueryContextMenu(pMenu, 0, CMD_FIRST, CMD_LAST, CMF.EXPLORE Or CMF.NORMAL)
...
#Region "DLL Import"
        ...
        Private Shared Function SHGetDesktopFolder(ByRef ppshf As IntPtr) As Int32
        End Function
        ...
        Private Shared Function StrRetToBuf(ByVal pstr As IntPtr, ByVal pidl As IntPtr, ByVal pszBuf As StringBuilder, ByVal cchBuf As Integer) As Int32
        End Function
