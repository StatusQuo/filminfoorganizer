Public Class InfoPanel_Episode
...
#Region "Toolbar"
    Private Sub ToolStripButton3_DropDownOpening(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton3.DropDownOpening
        ...
        '    If Not SelectedEpisode.State_Cover = 2 Then
        '        r = New ToolStripMenuItem
        '        r.Text = SelectedEpisode.State_Cover_text
        '        r.Image = Toolbar16.staty_16_cover_test
        '        ToolStripButton3.DropDownItems.Add(r)
        '        For Each x In SelectedEpisode.State_Cover_tip
        ...
        '        Next
        '    End If
        '    If Not SelectedEpisode.State_Backdrop = 2 Then
        '        r = New ToolStripMenuItem
    ...
    Private Sub Cover_Size_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cover_Size.Click
        If Not SelectedEpisode Is Nothing Then
            ...
            If CStr(Cover_Size.Tag) = "Size" Then
                ...
                If IO.File.Exists(SelectedEpisode.bild) Then
                    Cover_Size.Text = WebFunctions.FormatBytes(FileLen(SelectedEpisode.bild))
                Else
                    Cover_Size.Text = ""
...
#Region "Loading"
    ...
    Public Sub arr_to_Panel_Refresh(ByVal m As Episode)
        ...
        If m.Rate_Cover = 2 And m.Rate_Filename = 2 And m.Rate_Info = 2 And m.Rate_MediaInfo = 2 Then
    ...
    Public Sub arr_to_Panel_Cover(ByVal m As Episode)



        With Me
            If IO.File.Exists(m.bild) Then
                Try

                    Dim oStream As New System.IO.FileStream(m.bild, IO.FileMode.Open)
                    ...
                    If CStr(.Cover_Size.Tag) = "Size" Then
                        .Cover_Size.Text = .PictureBox1.Image.Size.Height & "x" & .PictureBox1.Image.Size.Width
                    Else
                        .Cover_Size.Text = WebFunctions.FormatBytes(FileLen(m.bild))
                    End If
