...
#Region "   Private Fields"
    ...
    Private m_LastTarget As Film_Info__Organizer.ShellDll.IDropTarget     'Of most recent Folder dragged over
...
#End Region
    ...
    Public Function DragEnter(ByVal pDataObj As IntPtr, _
                        ...
                        Implements Film_Info__Organizer.ShellDll.IDropTarget.DragEnter
    ...
    Public Function DragOver(ByVal grfKeyState As Integer, _
                                ByVal pt As POINT, _
                                ByRef pdwEffect As Integer) As Integer _
                        Implements Film_Info__Organizer.ShellDll.IDropTarget.DragOver
    ...
    Public Function DragLeave() As Integer Implements Film_Info__Organizer.ShellDll.IDropTarget.DragLeave
    ...
    Public Function DragDrop(ByVal pDataObj As IntPtr, _
                                ...
                                ByVal pt As POINT, _
                                ByRef pdwEffect As Integer) As Integer _
                            Implements Film_Info__Organizer.ShellDll.IDropTarget.DragDrop
