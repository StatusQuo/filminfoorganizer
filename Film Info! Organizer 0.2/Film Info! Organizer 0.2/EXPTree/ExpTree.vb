...
Imports Film_Info__Organizer.CShItem
Imports Film_Info__Organizer.ShellDll
Imports Film_Info__Organizer.SystemImageListManager
...
Public Class ExpTree
    ...
    Friend WithEvents tv1 As Film_Info__Organizer.TreeViewVista
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim TreeNode1 As System.Windows.Forms.TreeNode = New System.Windows.Forms.TreeNode("Verzeichnisse")
        Dim TreeNode2 As System.Windows.Forms.TreeNode = New System.Windows.Forms.TreeNode("Favoriten")
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ExpTree))
        Me.tv1 = New Film_Info__Organizer.TreeViewVista()
        Me.TreeviewImagelist = New System.Windows.Forms.ImageList(Me.components)
        Me.SuspendLayout()
        '
        'tv1
        '
        Me.tv1._Autosize = False
        Me.tv1.BorderStyle = System.Windows.Forms.BorderStyle.None
        Me.tv1.Dock = System.Windows.Forms.DockStyle.Top
        Me.tv1.FullRowSelect = True
        Me.tv1.HideSelection = False
        Me.tv1.HotTracking = True
        Me.tv1.ImageIndex = 0
        Me.tv1.ImageList = Me.TreeviewImagelist
        Me.tv1.ItemHeight = 20
        Me.tv1.Location = New System.Drawing.Point(0, 0)
        Me.tv1.Name = "tv1"
        TreeNode1.Name = "Knoten0"
        TreeNode1.Text = "Verzeichnisse"
        TreeNode2.Name = "Knoten1"
        TreeNode2.Text = "Favoriten"
        Me.tv1.Nodes.AddRange(New System.Windows.Forms.TreeNode() {TreeNode1, TreeNode2})
        Me.tv1.SelectedImageIndex = 0
        Me.tv1.ShowLines = False
        Me.tv1.Size = New System.Drawing.Size(200, 262)
        Me.tv1.TabIndex = 0
        '
        'TreeviewImagelist
        '
...
#Region "   TreeView AfterSelect Event"
    Private Sub tv1_AfterSelect(ByVal sender As System.Object, ByVal e As System.Windows.Forms.TreeViewEventArgs) Handles tv1.AfterSelect
        ...
        If TypeOf e.Node.Tag Is CShItem Then
...
#Region "   RefreshNode Sub"
    ...
    Private Sub RefreshNode(ByVal thisRoot As TreeNode)
        ...
        If TypeOf (thisRoot.Tag) Is CShItem Then
